...
for r1 in runs:
    for m1 in models:
        ...
        # read modeled flow
        f1 = '/home/yuqiong.liu/reg_ngen/fihm/output/flow_20081001_20140930_noah_owp_' + scenario + '.csv'
        if scenario=="obs.":
           f1 = '/home/yuqiong.liu/reg_ngen/fihm/output/usgs_hourly_flow_20081001_20140930_huc01.csv'
